...
document.addEventListener('click', function (e) {
    if (!serviceBtn.contains(e.target) && !serviceOptions.contains(e.target)) {
...
function openGoogleMap() {
    // Replace with your company or location's Google Maps link
    const locationURL = "https://maps.app.goo.gl/6dd4tDMeGJqFBeRNA";
